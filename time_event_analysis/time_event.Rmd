...
surv_df <- cohort_df %>% 
  mutate(survival_time = 
           int_length( interval( hosp_disch_time, contact_date_time  ) )/(24*60*60)   
         )

# View(
#   select( 
#     filter(surv_df, !is.na(contact_date_time), dx_autoth ) , 
#     survival_time, contact_date_time, hosp_disch_time 
#     ) 
#   )
```
