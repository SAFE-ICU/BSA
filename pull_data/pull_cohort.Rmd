...
dx_outcome_df <- dx_icd9 %>%  
  bind_rows(dx_dxid) %>% 
  filter( dx_autoth | dx_celiac | dx_t1dm )


# Merge onto the treatment_df table
treatment_df <- read_csv("/Users/Tarun/Documents/BIO_RESEARCH/pull_data/treatment_df.csv")



# Find only diagnoses that happen 2 weeks after exposure but before 2 years after exposure
```
